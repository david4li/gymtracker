...
import { GROUP_TYPES } from "@/lib/db/schema";
import type { RoutineInput } from "@/lib/actions/routines";
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      try {
        ...
        // redirect() throws internally on success — only real errors reach here.
        setError("Something went wrong saving this routine.");
      }
    });
  }
